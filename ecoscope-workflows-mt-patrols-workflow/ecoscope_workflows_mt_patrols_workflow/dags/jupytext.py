...
patrol_obs = (
    ...
    .partial(client=smart_client_name, time_range=time_range, **patrol_obs_params)
    .call()
)
...
split_by_station = (
    ...
    .partial(df=sql_query_traj, groupers=station_groupers, **split_by_station_params)
    .call()
)
